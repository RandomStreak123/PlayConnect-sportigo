...
const translations = {
  en: {
    ...
    statsHistory: 'Policies & Guidelines',
    statsHistorySub: 'Safety, Conduct & Account Recovery',
    signOut: 'Sign Out',
  ...
  hi: {
    ...
    statsHistory: 'नीतियां और दिशानिर्देश',
    statsHistorySub: 'सुरक्षा, आचरण और खाता पुनर्प्राप्ति नीतियां',
