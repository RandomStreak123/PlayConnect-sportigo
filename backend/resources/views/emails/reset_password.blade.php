          ...
          <tr>
            <td style="padding: 40px 30px; color: #2d3748; line-height: 1.6;">
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 30px;">
                <tr>
                  <td align="center">
                    <a href="{{ $resetUrl }}" target="_blank" style="display: inline-block; padding: 14px 30px; background: linear-gradient(135deg, #3f51b5, #673ab7); color: #ffffff; text-decoration: none; font-size: 15px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 10px rgba(99, 102, 241, 0.3); transition: all 0.2s ease;">
                      Reset Password
                    </a>
                  </td>
                </tr>
